...
namespace HelpDesk.API.Application.Mappers
{
    ...
    {
        public static Tecnico ToTecnicoEntity(this TecnicoRequestDto obj)
        {
            return new Tecnico
            {
        ...
        public static void MapToExisting(this TecnicoRequestDto obj, Tecnico entity)
        {
            entity.Nome = obj.Nome;
            entity.Email = obj.Email;
            entity.Especialidade = obj.Especialidade;
